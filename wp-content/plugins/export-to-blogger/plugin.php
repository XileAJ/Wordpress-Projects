...
/*
 ...
 Plugin URI: https://am-tb.tk/wordpress2blogger/en/
 Description: Export Wordpress data to Blogger(Blogspot) XML.
 Version: 1.1.1
 Author: am-tb.tk
 Author URI: https://am-tb.tk/en/
...
?>
	...
	<div id="ew2bc_message"></div>
		...
		<div class="ew2bc_other">
			<a href="<?php _e('https://am-tb.tk/wordpress2blogger/en/', 'export-to-blogger' ); ?>" target="_blank" rel="noopener">
			...
			<hr>
			<a href="<?php _e('https://am-tb.tk/amaranrss/en/', 'export-to-blogger' ); ?>" target="_blank" rel="noopener">
